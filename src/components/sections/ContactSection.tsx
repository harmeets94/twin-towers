              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-lg border border-dark-200 bg-dark-50 px-5 py-4 outline-none transition-all focus:border-primary-500 focus:bg-white focus:ring-2 focus:ring-primary-500/20 resize-none"
                  />
                  {errors.message && (
